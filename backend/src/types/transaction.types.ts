...
import { UUID, ISO8601DateTime, TransactionHash, StellarPublicKey } from './common.types';
import { StellarAssetInfo } from './stellar.types';

export type TransactionType = 'rent_payment' | 'security_deposit' | 'deposit_release' | 'agent_commission' | 'refund';
